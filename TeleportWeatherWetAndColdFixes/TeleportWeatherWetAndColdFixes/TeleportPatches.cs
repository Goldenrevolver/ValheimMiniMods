...
namespace TeleportWeatherWetAndColdFixes
{
    ...
    internal static class PatchPlayer
    {
        public static void Prefix(Player __instance, ref bool __state)
        {
            ...
            if (TeleportWeatherWetAndColdFixesPlugin.TeleportChange.Value == TeleportChange.Disabled)
            {
                return;
            }
        ...
        public static void Postfix(Player __instance, ref bool __state)
        {
            ...
            if (__state && !__instance.m_teleporting)
            {
                ...
                {
                    __instance.m_seman.RemoveStatusEffect(SEMan.s_statusEffectWet);
                    __instance.m_seman.RemoveStatusEffect(SEMan.s_statusEffectCold);
                    __instance.m_seman.RemoveStatusEffect(SEMan.s_statusEffectFreezing);
                }
            }
        }
    }
