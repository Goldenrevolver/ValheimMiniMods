...
#pragma warning disable 0169, 0414, 0649
    ...
    internal sealed class ConfigurationManagerAttributes
    {
        ...
        {
            return HiddenDisplay(() => HasPlugin(plantEverything), description, acceptableValues);
        }
        ...
        {
            return SeeOnlyDisplay(() => HasPlugin(plantEverything),
                "Whether you can plant regrowing blue mushrooms in frost caves. This is automatically disabled when 'Plant Everything' is installed.",
                "Cave mushroom planting is disabled in favor of the mushrooms from the 'Plant Everything' mod.",
                "Disabled in favor of 'Plant Everything' mod", acceptableValues);
        }
