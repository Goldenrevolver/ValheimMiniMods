...
#pragma warning disable 0169, 0414, 0649
    ...
    {
        internal static ConfigDescription SimpleOrderOverride(int order)
        {
            return new ConfigDescription(string.Empty, null, OrderOverride(order));
        }

        internal static ConfigurationManagerAttributes OrderOverride(int order)
        {
