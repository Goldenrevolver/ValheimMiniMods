...
#pragma warning disable 0169, 0414, 0649
    ...
    {
        internal static ConfigDescription ShowAsPercentOverride<T>(bool showRangeAsPercent, AcceptableValueRange<T> acceptableValues, string description = "") where T : IComparable
        {
            return new ConfigDescription(description, acceptableValues, new ConfigurationManagerAttributes() { ShowRangeAsPercent = showRangeAsPercent });
        }
